  ...
  return (
    <div className="py-20 px-6 font-sans text-gray-900 rounded-4xl">
      ...
      <section className="flex flex-col items-center justify-center text-center py-24 px-4 bg-gradient-to-br from-blue-300 to-white rounded-3xl">
        ...
        <Button size="lg" variant="ghost" className="text-white">Solicita una demo</Button>
      </section>

      {/* Sección Servicios */}
      <section id="servicios" className="py-20 px-6  text-amber-50 rounded-4xl ">
      ...
      <section className="flex flex-col items-center justify-center text-center py-24 px-4 bg-gradient-to-br from-blue-300 to-white rounded-3xl">
        ...
        <Button variant="ghost" className="text-white">Contáctanos</Button>
      </section>
    </div>
  )
}
